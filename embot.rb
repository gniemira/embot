...
require './lib/embot/messagehandler/bart.rb'
require './lib/embot/messagehandler/rubric.rb'
require './lib/embot/messagehandler/yourewelcome.rb'
require './lib/embot/messagehandler/yelp.rb'
require './lib/embot/messagehandler/twit.rb'
